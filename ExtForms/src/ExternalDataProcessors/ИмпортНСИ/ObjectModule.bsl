...
Функция СведенияОВнешнейОбработке() Экспорт
	ДанныеДляРег=ДополнительныеОтчетыИОбработки.СведенияОВнешнейОбработке();
	ДанныеДляРег.БезопасныйРежим=Ложь;
	ДанныеДляРег.Версия="1.0";
	ДанныеДляРег.Наименование="Внешняя обработка загрузки НСИ в справочники системы";
	ДанныеДляРег.Вид=ДополнительныеОтчетыИОбработкиКлиентСервер.ВидОбработкиДополнительнаяОбработка();
	НоваяКоманда=ДанныеДляРег.Команды.Добавить();
	НоваяКоманда.Идентификатор="ВнешняяОбработкаЗагрузка_СКФОМС_НСИ";
	НоваяКоманда.Представление="Внешняя обработка Загрузка СКФОМС-НСИ";
	...
	Если 1=2 Тогда
       ...
       ДанныеДляРег.Вставить("Версия", "ver.: 1.0");
